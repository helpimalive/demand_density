...
Importantly, we standardize rent-growth subtracting each year's median rent growth. We do this to remove the impact of national macroeconomic shocks (i.e., COVID-19). Analyses are performed to show effects on both standardize and non-standardized real rent growth figures.
...
Within the 200 MSAs in the study,the RDI ranges from 1.68 (Bloomington, IN; 2023) to 3.74 (Provo, UT; 2009). A choropleth showing the RDI for various regions is shown in Figure \ref{fig:choropleth_panel} below. 
...
\subsection{Instrumental Variable Justification: Share of Population Born in the MSA 20 Years Ago}\label{instrumental-variable}
...
\subsection{Two Stage Specification}\label{sec:instrumental-variable}
...
\newpage
\begin{appendices}
\section*{Appendix A: Spillover Effect Correlation Matrix}\label{appendix_a}
\begin{table}[h]
	\centering
