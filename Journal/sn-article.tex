...
We define density simply, as the population divided by the number of occupied rental units in an MSA. 
This assumes a latent level of rentership and family sizes nationally. There is homogeneity in this density ratio across both time and geography, with the mean density decreasing in sync with the observed decrease in people-per-household in the US [find reference].
\begin{figure}[h]
	\centering
